...
import { ClassPropertyParserData } from './interfaces/data.interface';
import { ClassPropertyParserJson } from './interfaces/json.interface';
...
export class ClassPropertyParser extends Parser {
    ...
    public constructor(data: ClassPropertyParserData) {
        super(data);
     ...
     */
    public override toJSON(): ClassPropertyParserJson {
        return {
            ...super.toJSON(),
