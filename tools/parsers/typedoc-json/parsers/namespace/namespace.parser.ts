...
import { NamespaceParserData } from './interfaces/data.interface';
import { NamespaceParserJson } from './interfaces/json.interface';
...
export class NamespaceParser extends Parser {
    ...
    public constructor(data: NamespaceParserData) {
        super(data);
     ...
     */
    public override toJSON(): NamespaceParserJson {
        return {
            ...super.toJSON(),
    ...
    public static generateFromTypeDoc(
        ...
        if (kind !== ReflectionKind.Namespace)
            throw new Error(
                `Expected Namespace (${ReflectionKind.Namespace}), but received ${kindString} (${kind})`
            );
     ...
     * @returns The generated parser.
     */
    public static generateFromJson(json: NamespaceParserJson): NamespaceParser {
        const {
            id,
            name,
            comment,
