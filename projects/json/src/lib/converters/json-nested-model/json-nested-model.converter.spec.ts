...
import { School } from '@ngx-material-dashboard/json/test/models/school.model';
import { JsonNestedModelConverter } from './json-nested-model.converter';

describe('JsonNestedModelConverter', () => {
    let converter: JsonNestedModelConverter<any>;
    ...
    describe('unmask method', () => {
        ...
        describe('ObjectModel - nullable', () => {
            ...
            it('should return serialized school when provided School instance', () => {
                ...
                expect(result.foundation).toEqual(parseISO(DATA.foundation));
            });
        });
    });
});
