...
/**
 * A button to display above a table. A toolbar button should have either a
 ...
 *
 * const CREATE_TOOLBAR_BUTTON: TableToolbarButton = {
 *     canDisable: false,
 *     disabled: false,
 ...
 * ## Features
 * 
 * The `TableToolbarButton` interface provides several optional features for
