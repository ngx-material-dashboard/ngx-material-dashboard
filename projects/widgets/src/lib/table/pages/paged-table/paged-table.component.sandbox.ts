...
.add('table with multi-select', {
    template: `
    <ngx-material-dashboard-paged-table matSort [collectionButtons]="buttons" [data]="data" [displayedColumns]="displayedColumns" [multiple]="multiple" class="marker-paged-table">
