...
describe('MenuElement', () => {
    ...
    describe('Default constructor properties', () => {
        beforeEach(() => {
            TestBed.configureTestingModule({
                declarations: [Menu],
                imports: [MatButtonModule, MatMenuModule, NoopAnimationsModule]
            });
        ...
        it('should click the button in the menu when clickButton method called', () => {
            ...
            menu.clickButton('.marker-button-search');
            fixture.detectChanges();
    ...
    describe('Custom constructor properties', () => {
        beforeEach(() => {
            TestBed.configureTestingModule({
                declarations: [Menu],
                imports: [MatButtonModule, MatMenuModule, NoopAnimationsModule]
