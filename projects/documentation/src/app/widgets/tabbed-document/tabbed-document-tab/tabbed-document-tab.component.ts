...
const USAGE_NOTES_MAP: UsageNoteMap = {"/widgets/components/paged-table/overview":{"## Basic Local Data Usage":["assets/docs/widgets/components/paged-table/usage-notes-1-html.md","assets/docs/widgets/components/paged-table/usage-notes-1-typescript.md"],"## Remote Data Usage Example":["assets/docs/widgets/components/paged-table/usage-notes-2-html.md","assets/docs/widgets/components/paged-table/usage-notes-2-typescript.md"],"usage-notes":["assets/docs/widgets/components/paged-table/usage-notes-html.md","assets/docs/widgets/components/paged-table/usage-notes-typescript.md"]},"/widgets/components/paged-table-with-toolbar/overview":{"usage-notes":["assets/docs/widgets/components/paged-table-with-toolbar/usage-notes.md"]}};
