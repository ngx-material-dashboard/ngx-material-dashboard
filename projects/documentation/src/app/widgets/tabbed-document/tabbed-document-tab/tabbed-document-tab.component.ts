...
const USAGE_NOTES_MAP: UsageNoteMap = {"/widgets/components/paged-table/overview":{"## Basic Usage":["assets/docs/widgets/components/paged-table/usage-notes-html.md","assets/docs/widgets/components/paged-table/usage-notes-typescript.md"]},"/widgets/components/paged-table-with-toolbar/overview":{"usage-notes":["assets/docs/widgets/components/paged-table-with-toolbar/usage-notes.md"]}};
